...
mod tests {
    ...
    /// Test extension‑based language detection for various file names.
    #[test]
    fn test_detect_from_path() {
        #[cfg(feature = "rust-lang")]
        assert_eq!(
            TreeSitterLanguage::detect_from_path(Path::new("main.rs")),
            Some(TreeSitterLanguage::Rust)
        );
        #[cfg(feature = "python")]
        assert_eq!(
            TreeSitterLanguage::detect_from_path(Path::new("script.py")),
            Some(TreeSitterLanguage::Python)
        );
        #[cfg(feature = "javascript")]
        assert_eq!(
            TreeSitterLanguage::detect_from_path(Path::new("app.js")),
            Some(TreeSitterLanguage::JavaScript)
        );
        #[cfg(feature = "cpp")]
        assert_eq!(
            TreeSitterLanguage::detect_from_path(Path::new("main.cpp")),
            Some(TreeSitterLanguage::Cpp)
        );

        #[cfg(feature = "sql")]
        assert_eq!(
            TreeSitterLanguage::detect_from_path(Path::new("query.sql")),
            Some(TreeSitterLanguage::Sql)
        );
        #[cfg(feature = "perl")]
        assert_eq!(
            TreeSitterLanguage::detect_from_path(Path::new("script.pl")),
            Some(TreeSitterLanguage::Perl)
        );
        #[cfg(feature = "r")]
        assert_eq!(
            TreeSitterLanguage::detect_from_path(Path::new("analysis.r")),
            Some(TreeSitterLanguage::R)
        );
        #[cfg(feature = "dart")]
        assert_eq!(
            TreeSitterLanguage::detect_from_path(Path::new("main.dart")),
            Some(TreeSitterLanguage::Dart)
        );
        #[cfg(feature = "elixir")]
        assert_eq!(
            TreeSitterLanguage::detect_from_path(Path::new("mix.exs")),
            Some(TreeSitterLanguage::Elixir)
        );
        #[cfg(feature = "toml")]
        assert_eq!(
            TreeSitterLanguage::detect_from_path(Path::new("Cargo.toml")),
            Some(TreeSitterLanguage::Toml)
        );
        #[cfg(feature = "ini")]
        assert_eq!(
            TreeSitterLanguage::detect_from_path(Path::new("config.ini")),
            Some(TreeSitterLanguage::Ini)
        );
    }

    /// Test parsing language names, including aliases.
    #[test]
    fn test_parse_language() {
        #[cfg(feature = "rust-lang")]
        assert_eq!(
            TreeSitterLanguage::from_str("rust").ok(),
            Some(TreeSitterLanguage::Rust)
        );
        #[cfg(feature = "rust-lang")]
        assert_eq!(
            TreeSitterLanguage::from_str("rs").ok(),
            Some(TreeSitterLanguage::Rust)
        );
        #[cfg(feature = "python")]
        assert_eq!(
            TreeSitterLanguage::from_str("python").ok(),
            Some(TreeSitterLanguage::Python)
        );
        #[cfg(feature = "cpp")]
        assert_eq!(
            TreeSitterLanguage::from_str("c++").ok(),
            Some(TreeSitterLanguage::Cpp)
        );

        #[cfg(feature = "sql")]
        assert_eq!(
            TreeSitterLanguage::from_str("sql").ok(),
            Some(TreeSitterLanguage::Sql)
        );
        #[cfg(feature = "perl")]
        assert_eq!(
            TreeSitterLanguage::from_str("perl").ok(),
            Some(TreeSitterLanguage::Perl)
        );
        #[cfg(feature = "r")]
        assert_eq!(
            TreeSitterLanguage::from_str("r").ok(),
            Some(TreeSitterLanguage::R)
        );
        #[cfg(feature = "dart")]
        assert_eq!(
            TreeSitterLanguage::from_str("dart").ok(),
            Some(TreeSitterLanguage::Dart)
        );
        #[cfg(feature = "elixir")]
        assert_eq!(
            TreeSitterLanguage::from_str("elixir").ok(),
            Some(TreeSitterLanguage::Elixir)
        );
        #[cfg(feature = "toml")]
        assert_eq!(
            TreeSitterLanguage::from_str("toml").ok(),
            Some(TreeSitterLanguage::Toml)
        );
        #[cfg(feature = "ini")]
        assert_eq!(
            TreeSitterLanguage::from_str("ini").ok(),
            Some(TreeSitterLanguage::Ini)
        );
    }

    /// Ensure the list of supported languages is never empty (if any feature is enabled).
    #[test]
    fn test_supported_includes_enabled() {
        let supported = TreeSitterLanguage::supported();
        // At least one language should be present in a normal build
        assert!(!supported.is_empty());
    }

    /// Verify that every enabled language has a corresponding query in the static map.
    #[test]
    fn test_queries_exist_for_enabled() {
        #[cfg(feature = "rust-lang")]
        assert!(COMMENT_QUERIES.contains_key(&TreeSitterLanguage::Rust));
        #[cfg(feature = "python")]
        assert!(COMMENT_QUERIES.contains_key(&TreeSitterLanguage::Python));
        // Additional checks could be added, but these are sufficient as a sanity check.
    }
}